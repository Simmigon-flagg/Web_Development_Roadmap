...
1. Text/Code Editor
1. Web Browers
1. Editor Extenstions
1. Design and Mockup
1. Deployment Tools
1. 3rd Party Terminals
...
1. Domain Name
1. Mananged Hosting with cPanel
1. FTP/SFTP File Uploader - Filezilla
1. Static Hosting - Netlify, Github Pages
...
1. HTML / CSS 
   . Bootstrap
   . Materlize and Material 
1. Front-End
   . React (Most used)
   . Vue (Easiest)
   . Anguluar (Used by Large Corpation)
